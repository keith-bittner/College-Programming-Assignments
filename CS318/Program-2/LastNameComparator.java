...
/**
* <h1>LastNameComparator.java</h1> 
* This is the comparator class for the Candidate ADT that compares Last names.
* 
* @author Keith Bittner
* @version 1.3
* @since 2020-02-13
*/
public class LastNameComparator implements Comparator<Candidate> {

	/**
	* This method is used to compare two candidates by last name.
	*
