...
public class Time
{
	...
	*/
	public String setTime (int newHour, int newMin)
	{
		...
		{
			valid = "Invalid input for hour."; // hour is out of range
		}
		
		if (newMin < 0 || newMin > 59)
		{
			valid = "Invalid input for minute."; // minutes are out of range
		}
	...
	*/	
	public Time difference (Time that)
	{
		...
		if (startMin >= endMin) // if this > that, subtract and add 24 hours
		{
			timeDiffer = (startMin - endMin) + 1440; // 24hrs * 60min = 1440
		}
		else // if that > this
		{
